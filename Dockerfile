...
RUN apt-get update
RUN apt-get install bsdutils
RUN apt-get install fdisk
RUN apt-get install libblkid1
RUN apt-get install libfdisk1
RUN apt-get install libmount1
RUN apt-get install libsmartcols1
RUN apt-get install libuuid1
